...
\email{tao.yang@apctp.org $\;\;\bullet$ \today}
...
\newline{}
\protect{$~\qquad\qquad\qquad\quad\;\;\;$}
\emph{Asia Pacific Center for Theoretical Physics},
\newline{}
\protect{$~\qquad\qquad\qquad\quad\;\;\;$}
...
\cventry{2019.8-Now}{Postdoctoral fellow}{Asia Pacific Center for Theoretical Physics}{Pohang, Korea}{}{}
\vspace{-0.1cm}
...
\textbf{$\bullet$} & & Gaussian processes reconstruction of modified gravitational wave propagation,
  ...
  Phys.Rev. D101 (2020) no.6, 063505,
  arXiv: 1911.11497.
\vspace{0.05cm}\\
...
%Bash
.}
\cvitem{Data analysis skills}{Gaussian Process, Markov Chain Monte Carlo (CosmoMC, Cobaya, emcee), various data analysis in Gravitational waves cosmology and Strong gravitational lensing .}
