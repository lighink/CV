...
\cvitem{Present position}{Ph.D. candidate
\newline{}
\protect{$~\qquad\qquad\qquad\quad\;\;\;$}
\emph{Institute of Theoretical Physics, Chinese Academy of Sciences},
\newline{}
\protect{$~\qquad\qquad\qquad\quad\;\;\;$}
...
Note: I am the main contributor of all the listed publications.
...
%Bash
.}
\cvitem{data analysis method}{Gaussian Processes, Markov Chain Monte Carlo, Nested Sampling, Simulations of mock data.}
