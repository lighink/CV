...
Unlike the traditional way to use the Einstein radius from electromagnetic domain, in the recent paper~\cite{Yang:2017bdf}, we propose a multi-messenger approach by combining data from both gravitational wave and the corresponding electromagnetic  counterpart.
