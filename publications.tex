...
\textcolor{color1}{\textbf{Total number of citations:}} \textbf{171} (using InSpire).

\textcolor{color1}{\textbf{${h_{\texttt{hep}}}$-index:}} \textbf{7}
...
\newline{}
\href{https://arxiv.org/abs/1810.00164}{arXiv:1810.00164 [astro-ph.CO]}.
\vspace{0.09cm}\\
%
