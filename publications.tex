...
\textcolor{color1}{\textbf{Total number of citations:}} \textbf{180} (using InSpire).
...
%
\textbf{2.} & & \textit{New probe of gravity: strongly lensed gravitational wave multi-messenger approach.} 
\newline{}
